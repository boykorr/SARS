...
def user_login(request):
    ...
    if request.method == 'POST':
        ...
        # username/password combination is valid - a User object is returned if it is.
        ...
        if user:
            ...
            if user.is_active:
                ...
                return HttpResponse("Your SARS account is disabled.")
        else:
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        return render(request, 'SARS/login.html', {})
