$(document).ready(function(){
    ...
    */
    ...
    $("button[id=btn_goBack]").click(function(){
        window.history.back();
    });
    ...
    $("input[name=docCheckbox]").change(function() {
        if(this.checked) {
            $(this).parent().css("background-color", "#d7ffcb");
        } else {
            $(this).parent().css("background-color", "#e0dee1");
        }
    });
